...
if (Loader::includeModule('search'))
{
	...
	else
	{
		...
		{
		    $APPLICATION->SetTitle('НЕТ СОВПАДЕНИЙ ПО ЗАПРОСУ: '.$_GET['q']);
			?>
            <section class="negative">
                <img class="negative__ico" src="<?=SITE_TEMPLATE_PATH?>/images/search-big-ico.svg" alt="Повторите попытку, используя другое написание или ключевые слова">
                <p class="negative__text subtitle">Повторите попытку, используя другое написание или ключевые слова</p>
            </section>
