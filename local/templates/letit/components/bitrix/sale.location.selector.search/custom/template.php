...
<?else:?>
    ...
    <form class="shops__map-form" action="">
        <label class="shops__search-label">
            <img class="shops__search-ico" src="<?=SITE_TEMPLATE_PATH?>/images/ico/search.svg" alt="Поиск">
            <input class="shops__search search-input" placeholder="Введите название нужного вам города" type="text" id="suggest">
            <button class="shops__search-btn" type="reset"></button>
        </label>
    </form>
